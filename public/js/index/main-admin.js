        ...
        store.forEach((product, indexProduct) => {
            if (product.Stock > 0) {
                ...
                productItem.innerHTML = `
                    ...
                    <button class="product-item-button" onclick="selectProduct('${storeName}', ${indexProduct})">Comprar</button>
                `        
...
async function selectProduct(storeName,indexProduct) {
    ...
    await pywebview.api.view_api.admin_buy_product_view()
}
                ...
                if (product.Stock > 0) {
                    ...
                    document.querySelector(".search-product").innerHTML = `
                        <div class="product-item">
                            ...
                            <button onclick="selectProduct('${storeName}', ${store.indexOf(product)})" class="product-item-button">Comprar</button>
                        </div>
                    `
                } else {
